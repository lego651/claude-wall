...
- **Where:** The daily scrape workflow (`.github/workflows/daily-step1-sync-firm-trustpilot-reviews.yml`) runs `scripts/backfill-firm-trustpilot-reviews.ts`. That script (1) scrapes all firms, (2) then runs **retention cleanup** in the same process:
