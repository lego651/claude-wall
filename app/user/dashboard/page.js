      ...
      <div className="bg-white border-b border-slate-200 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-1">My Dashboard</h1>
              {profile?.created_at && (
                <div className="flex items-center gap-1.5 text-xs sm:text-sm text-slate-500">
                  <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: '#635BFF' }}>
            ...
            <div className="flex flex-wrap gap-2">
              <Link
                href="/user/settings"
                className="px-3 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-semibold hover:bg-slate-50 transition-colors flex items-center gap-1.5"
              >
              ...
              <Link
                ...
                className="px-3 py-2 text-white rounded-lg text-sm font-semibold transition-colors flex items-center gap-1.5"
                style={{ backgroundColor: "#635BFF" }}
                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "#5a52e6"; }}
