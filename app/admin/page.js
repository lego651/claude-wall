      ...
      <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <section className="space-y-12">
          ...
          <div className="flex flex-col items-center gap-3 pt-8">
            ...
            <h2 className="text-3xl font-black text-gray-900">Manage News Sources</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-1 gap-6 max-w-sm mx-auto">
            <MenuCard
              title="YouTube Channels & Keywords"
              description="Manage the channel watchlist and keyword searches that power the daily /news page picks."
              icon="▶"
              href="/admin/news/channels"
              badge="New"
              color="bg-white"
            />
          </div>
