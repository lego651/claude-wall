...
/** Map internal state ID → URL slug (reverse of TAB_SLUG_TO_INTERNAL, excluding email-ingest alias). */
const TAB_INTERNAL_TO_SLUG = {
  payouts: 'payouts',
  daily1: 'daily-scrape',
  daily2: 'daily-classify',
  daily3: 'daily-incidents',
  weekly1: 'weekly-reports',
  weekly2: 'weekly-digest',
  twitter: 'twitter',
};
