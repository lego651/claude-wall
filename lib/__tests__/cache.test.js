...
import { get, set, invalidate, getCacheStats, cache } from '@/lib/cache';
...
describe('lib/cache', () => {
  ...
  it('exports get, set, invalidate, getCacheStats and cache object', () => {
    expect(typeof get).toBe('function');
    expect(typeof set).toBe('function');
    expect(typeof invalidate).toBe('function');
    expect(typeof getCacheStats).toBe('function');
    expect(cache).toEqual({ get, set, invalidate, getCacheStats });
  });
